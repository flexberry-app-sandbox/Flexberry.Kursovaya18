...
namespace IIS.Kursovaya18
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya18.DetailArrayOfОказКонсульт fОказКонсулт;
        ...
        public virtual IIS.Kursovaya18.DetailArrayOfОказКонсульт ОказКонсулт
        {
            get
            {
                ...
                {
                    this.fОказКонсулт = new IIS.Kursovaya18.DetailArrayOfОказКонсульт(this);
                }
                IIS.Kursovaya18.DetailArrayOfОказКонсульт result = this.fОказКонсулт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Kursovaya18.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Kursovaya18.РасчетОстВрем));
                }
            }
        }
    }
