...
namespace IIS.Kursovaya18
{
    ...
    public class ОказКонсульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya18.Услуга fПредостУслуга;
        
        private int fНомер;
        
        private IIS.Kursovaya18.ПереченьУслуг fПереченьУслуг;
        
        private IIS.Kursovaya18.ЗаключДоговора fЗаключДоговора;
        
        private IIS.Kursovaya18.РасчетОстВрем fРасчетОстВрем;
        ...
        public virtual IIS.Kursovaya18.Услуга ПредостУслуга
        {
            get
            {
                ...
                IIS.Kursovaya18.Услуга result = this.fПредостУслуга;
        ...
        [PropertyStorage(new string[] {
                "ПереченьУслуг"})]
        [NotNull()]
        public virtual IIS.Kursovaya18.ПереченьУслуг ПереченьУслуг
        {
            get
            {
                ...
                IIS.Kursovaya18.ПереченьУслуг result = this.fПереченьУслуг;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kursovaya18.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Kursovaya18.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Kursovaya18.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказКонсультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказКонсультE", typeof(IIS.Kursovaya18.ОказКонсульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказКонсульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kursovaya18.DetailArrayOfОказКонсульт members)

        // *** End programmer edit section *** (IIS.Kursovaya18.DetailArrayOfОказКонсульт members)
        ...
        /// </summary>
        public DetailArrayOfОказКонсульт(IIS.Kursovaya18.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказКонсульт), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Kursovaya18.ОказКонсульт this[int index]
        {
            get
            {
                return ((IIS.Kursovaya18.ОказКонсульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kursovaya18.ОказКонсульт dataobject)
        {
